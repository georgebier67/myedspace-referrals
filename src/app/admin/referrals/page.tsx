...
export default function AdminDashboard() {
  ...
  const handleExport = async (type: 'referrals' | 'referrers') => {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          ...
          <div className="flex gap-2">
            ...
            >
              ...
              {exportLoading === 'referrals' ? 'Exporting...' : 'Export CSV'}
            </button>
            <button
              onClick={fetchData}
              className="btn-secondary flex items-center gap-2"
        ...
        <div className="mt-8">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-black text-[#101626] uppercase">
              Registered Referrers
            </h2>
            <button
              onClick={() => handleExport('referrers')}
              disabled={exportLoading !== null}
            ...
            >
              ...
              {exportLoading === 'referrers' ? 'Exporting...' : 'Export Referrers'}
            </button>
          </div>
